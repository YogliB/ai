...
[{{project}} Code of Conduct](https://github.com/{{repository}}/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code.

## I Have a Question

Before you ask a question, search existing [Issues](https://github.com/{{repository}}/issues).
